...
paragraphe `lien <chap-02.html#laragon>`__) et tapez la commande
suivante :
...
-  lignes 82-87 : traitent le cas particulier du code de statut **[500
   ...
   **[SendAdminMail]** a déjà été présentée (paragraphe
   `lien <chap-19.html#version9_sendadminmail>`__) ;
...
`lien <chap-23.html#version12_mainphp2>`__. Elle implémente l’interface
...
présentée également au paragraphe
`lien <chap-23.html#version12_mainphp2>`__ :
...
-  ligne 101 : construction de la couche **[dao]** lorsque les données
   ...
   **[ServerDaoWithRedis]** a été décrite au paragraphe
   `lien <chap-20.html#version10_serveur>`__ ;
...
-  ligne 119 : la couche **[métier]** est créée. La classe
   **[ServerMetier]** a été décrite au paragraphe
   `lien <chap-18.html#version8_serveur_métier>`__ ;
