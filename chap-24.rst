...
-  si vous avez créé un compte, une synchronisation se fait entre votre
   ...
   1. .. rubric:: La bibliothèque Symfony / Serializer
         :name: la-bibliothèque-symfony-serializer
...
-  ligne 54 : la réponse jSON est envoyée au client ;
   ...
   1. .. rubric:: Tests [Postman] - 1
         :name: tests-postman---1
...
-  ligne 10 : le contrôleur principal a terminé son travail ;
   ...
   1. .. rubric:: Tests [Postman] – 3
         :name: tests-postman-3
...
-  en **[9-12]**, la réponse jSON du serveur ;
   ...
   1. .. rubric:: L’action [authentifier-utilisateur]
         :name: laction-authentifier-utilisateur
...
-  en **[10-13]**, la réponse jSON du serveur. On remarquera le code de
   ...
   1. .. rubric:: L’action [calculer-impot]
         :name: laction-calculer-impot
...
-  en **[12-14]**, la réponse jSON du serveur ;
   ...
   1. .. rubric:: L’action [lister-simulations]
         :name: laction-lister-simulations
...
-  en **[3-6]**, la réponse jSON du serveur. Avant ce test, le test
   **[Postman]** **[calculer-impot-300]** avait été exécuté plusieurs
   ...
   1. .. rubric:: L’action [supprimer-simulation]
         :name: laction-supprimer-simulation
...
-  en **[1]**, il ne reste plus de simulations dans la session web du
   ...
   1. .. rubric:: L’action [fin-session]
         :name: laction-fin-session
...
-  ligne 5 : on l’instancie et on envoie la réponse au client grâce à la
   ...
   **[InterfaceResponse]**, les méthodes **[send]** des différents types
   ...
   1. .. rubric:: La classe [JsonResponse]
         :name: la-classe-jsonresponse
...
-  lignes 48-50 : on logue la réponse jSON ;
   ...
   1. .. rubric:: La classe [XmlResponse]
         :name: la-classe-xmlresponse
...
-  en **[4-7]**, la réponse XML du serveur ;
   ...
   1. .. rubric:: La réponse [HtmlResponse]
         :name: la-réponse-htmlresponse
...
2. .. rubric:: La vue d’authentification
      :name: la-vue-dauthentification

   1. .. rubric:: Présentation de la vue
         :name: présentation-de-la-vue
...
-  **[$modèle→erreurs]** : une liste (au sens HTML du terme) de messages
   ...
   1. .. rubric:: Le fragment [v-bandeau.php]
         :name: le-fragment-v-bandeau.php
...
-  **[$logo]** : URL de l’image affichée dans le bandeau ;
   ...
   1. .. rubric:: Le fragment [v-authentification.php]
         :name: le-fragment-v-authentification.php
...
-  **[Postman]** nous permet d’émettre des requêtes vers le serveur sans
   ...
   1. .. rubric:: La vue de calcul de l’impôt
         :name: la-vue-de-calcul-de-limpôt

      1. .. rubric:: Présentation de la vue
            :name: présentation-de-la-vue-1
...
-  lignes 71-87 : si le calcul de l’impôt échoue
   **[$modèle→error=TRUE]**, alors un message d’erreur est affiché dans
   ...
   1. .. rubric:: Le fragment [v-calcul-impot.php]
         :name: le-fragment-v-calcul-impot.php
...
1. .. rubric:: La vue de la liste des simulations
      :name: la-vue-de-la-liste-des-simulations

   1. .. rubric:: Présentation de la vue
         :name: présentation-de-la-vue-2
...
-  les changements de vue sont simples à implémenter : il suffit de
   ...
   1. .. rubric:: Tests en conditions réelles
         :name: tests-en-conditions-réelles
...
-  seule la méthode **[executeBatchImpots]** de la ligne 12 est
   ...
   1. .. rubric:: La classe [ClientMetier]
         :name: la-classe-clientmetier
...
.. |image10| image:: ./chap-24/media/image11.png
   :width: 1.27559in
   :height: 0.43346in
.. |image11| image:: ./chap-24/media/image12.png
   :width: 6.25984in
   :height: 1.90157in
.. |image12| image:: ./chap-24/media/image13.png
   :width: 1.56338in
   :height: 0.82717in
.. |image13| image:: ./chap-24/media/image14.png
   :width: 6.26378in
   :height: 1.92165in
.. |image14| image:: ./chap-24/media/image15.png
   :width: 1.19646in
   :height: 1.7563in
.. |image15| image:: ./chap-24/media/image16.png
   :width: 5.54724in
   :height: 1.66535in
.. |image16| image:: ./chap-24/media/image17.png
   :width: 5.26378in
   :height: 3.06654in
.. |image17| image:: ./chap-24/media/image18.png
   :width: 2.05472in
   :height: 2.20827in
.. |image18| image:: ./chap-24/media/image19.png
   :width: 2.70472in
   :height: 1.77559in
.. |image19| image:: ./chap-24/media/image20.png
   :width: 5.97638in
   :height: 2.85433in
.. |image20| image:: ./chap-24/media/image21.png
   :width: 6.19646in
   :height: 1.94843in
.. |image21| image:: ./chap-24/media/image22.png
   :width: 5.94528in
   :height: 1.22441in
.. |image22| image:: ./chap-24/media/image23.png
   :width: 4.70472in
   :height: 2.90157in
.. |image23| image:: ./chap-24/media/image24.png
   :width: 3.19291in
   :height: 1.91338in
.. |image24| image:: ./chap-24/media/image25.png
   :width: 5.34252in
   :height: 1.83464in
.. |image25| image:: ./chap-24/media/image26.png
   :width: 6.17717in
   :height: 2.46024in
.. |image26| image:: ./chap-24/media/image27.png
   :width: 5.54291in
   :height: 1.54724in
.. |image27| image:: ./chap-24/media/image28.png
   :width: 5.06654in
   :height: 1.28346in
.. |image28| image:: ./chap-24/media/image29.png
   :width: 1.61378in
   :height: 2.24449in
.. |image29| image:: ./chap-24/media/image30.png
   :width: 5.77992in
   :height: 2.37795in
.. |image30| image:: ./chap-24/media/image31.png
   :width: 5.17717in
   :height: 2.8937in
.. |image31| image:: ./chap-24/media/image32.png
   :width: 1.62992in
   :height: 1.86614in
.. |image32| image:: ./chap-24/media/image33.png
   :width: 6.00748in
   :height: 2.67717in
.. |image33| image:: ./chap-24/media/image34.png
   :width: 4.75197in
   :height: 3.06339in
.. |image34| image:: ./chap-24/media/image35.png
   :width: 5.1374in
   :height: 3.09843in
.. |image35| image:: ./chap-24/media/image36.png
   :width: 2.11024in
   :height: 2.00748in
.. |image36| image:: ./chap-24/media/image37.png
   :width: 5.51929in
   :height: 1.63386in
.. |image37| image:: ./chap-24/media/image38.png
   :width: 6.20472in
   :height: 2.66535in
.. |image38| image:: ./chap-24/media/image39.png
   :width: 4.72008in
   :height: 2.98819in
.. |image39| image:: ./chap-24/media/image40.png
   :width: 4.77992in
   :height: 3.00748in
.. |image40| image:: ./chap-24/media/image41.png
   :width: 6.30354in
   :height: 2.63386in
.. |image41| image:: ./chap-24/media/image42.png
   :width: 5.92913in
   :height: 2.68898in
.. |image42| image:: ./chap-24/media/image43.png
   :width: 5.98386in
   :height: 2.66929in
.. |image43| image:: ./chap-24/media/image44.png
   :width: 6.15748in
   :height: 2.75197in
.. |image44| image:: ./chap-24/media/image45.png
   :width: 6.16535in
   :height: 2.79921in
.. |image45| image:: ./chap-24/media/image46.png
   :width: 6.23622in
   :height: 2.70472in
.. |image46| image:: ./chap-24/media/image47.png
   :width: 6.20472in
   :height: 2.20827in
.. |image47| image:: ./chap-24/media/image48.png
   :width: 6.17717in
   :height: 3.17283in
.. |image48| image:: ./chap-24/media/image49.png
   :width: 5.85433in
   :height: 3.18898in
.. |image49| image:: ./chap-24/media/image50.png
   :width: 5.6063in
   :height: 3.62559in
.. |image50| image:: ./chap-24/media/image51.png
   :width: 5.94528in
   :height: 2.75197in
.. |image51| image:: ./chap-24/media/image52.png
   :width: 5.52362in
   :height: 1.51614in
.. |image52| image:: ./chap-24/media/image53.png
   :width: 5.97205in
   :height: 3.49252in
.. |image53| image:: ./chap-24/media/image54.png
   :width: 6.01929in
   :height: 2.65354in
.. |image54| image:: ./chap-24/media/image55.png
   :width: 6.09843in
   :height: 2.85079in
.. |image55| image:: ./chap-24/media/image56.png
   :width: 6.05906in
   :height: 2.64567in
.. |image56| image:: ./chap-24/media/image57.png
   :width: 2.35433in
   :height: 3.44528in
.. |image57| image:: ./chap-24/media/image58.png
   :width: 5.84646in
   :height: 3.47205in
.. |image58| image:: ./chap-24/media/image59.png
   :width: 6.1374in
   :height: 2.6374in
.. |image59| image:: ./chap-24/media/image60.png
   :width: 5.96024in
   :height: 2.55906in
.. |image60| image:: ./chap-24/media/image61.png
   :width: 5.96024in
   :height: 3.05906in
.. |image61| image:: ./chap-24/media/image62.png
   :width: 6.10197in
   :height: 2.99567in
.. |image62| image:: ./chap-24/media/image63.png
   :width: 5.8937in
   :height: 2.55906in
.. |image63| image:: ./chap-24/media/image64.png
   :width: 5.58268in
   :height: 3.53543in
.. |image64| image:: ./chap-24/media/image65.png
   :width: 5.61024in
   :height: 1.63386in
.. |image65| image:: ./chap-24/media/image66.png
   :width: 1.50748in
   :height: 1.63386in
.. |image66| image:: ./chap-24/media/image67.png
   :width: 6in
   :height: 2.75197in
.. |image67| image:: ./chap-24/media/image68.png
   :width: 5.96024in
   :height: 2.61024in
.. |image68| image:: ./chap-24/media/image69.png
   :width: 1.6374in
   :height: 2.09016in
.. |image69| image:: ./chap-24/media/image70.png
   :width: 6.03976in
   :height: 2.61811in
.. |image70| image:: ./chap-24/media/image71.png
   :width: 6.9252in
   :height: 4.12559in
.. |image71| image:: ./chap-24/media/image72.png
   :width: 6.64173in
   :height: 3.92165in
.. |image72| image:: ./chap-24/media/image73.png
   :width: 6.05472in
   :height: 3.83464in
.. |image73| image:: ./chap-24/media/image74.png
   :width: 6.55157in
   :height: 4.22008in
.. |image74| image:: ./chap-24/media/image75.png
   :width: 6.9689in
   :height: 2.7874in
.. |image75| image:: ./chap-24/media/image76.png
   :width: 6.49567in
   :height: 2.69646in
.. |image76| image:: ./chap-24/media/image77.png
   :width: 6.05472in
   :height: 3.83464in
.. |image77| image:: ./chap-24/media/image78.png
   :width: 2.12205in
   :height: 0.7563in
.. |image78| image:: ./chap-24/media/image79.png
   :width: 2.46024in
   :height: 0.88976in
.. |image79| image:: ./chap-24/media/image80.png
   :width: 5.58661in
   :height: 1.22441in
.. |image80| image:: ./chap-24/media/image81.png
   :width: 2.95709in
   :height: 2.01929in
.. |image81| image:: ./chap-24/media/image82.png
   :width: 2.97638in
   :height: 0.61378in
.. |image82| image:: ./chap-24/media/image83.png
   :width: 3.2126in
   :height: 0.37795in
.. |image83| image:: ./chap-24/media/image84.png
   :width: 3.05906in
   :height: 0.37795in
.. |image84| image:: ./chap-24/media/image85.png
   :width: 3.15354in
   :height: 0.44528in
.. |image85| image:: ./chap-24/media/image86.png
   :width: 1.14173in
   :height: 0.85079in
.. |image86| image:: ./chap-24/media/image87.png
   :width: 1.64921in
   :height: 1.6063in
.. |image87| image:: ./chap-24/media/image88.png
   :width: 7.07835in
   :height: 4.68465in
.. |image88| image:: ./chap-24/media/image89.png
   :width: 1.41339in
   :height: 1.59449in
.. |image89| image:: ./chap-24/media/image90.png
   :width: 4.90551in
   :height: 4.24449in
.. |image90| image:: ./chap-24/media/image91.png
   :width: 4.7563in
   :height: 4.41732in
.. |image91| image:: ./chap-24/media/image92.png
   :width: 6.12992in
   :height: 3.46024in
.. |image92| image:: ./chap-24/media/image93.png
   :width: 1.58661in
   :height: 1.58268in
.. |image93| image:: ./chap-24/media/image94.png
   :width: 4.41732in
   :height: 1.99567in
.. |image94| image:: ./chap-24/media/image95.png
   :width: 1.90984in
   :height: 0.38976in
.. |image95| image:: ./chap-24/media/image96.png
   :width: 3.40551in
   :height: 0.38622in
.. |image96| image:: ./chap-24/media/image97.png
   :width: 1.00433in
   :height: 0.64173in
.. |image97| image:: ./chap-24/media/image98.png
   :width: 2.02795in
   :height: 1.94528in
.. |image98| image:: ./chap-24/media/image99.png
   :width: 1.51181in
   :height: 1.60197in
.. |image99| image:: ./chap-24/media/image100.png
   :width: 1.81535in
   :height: 1.85079in
.. |image100| image:: ./chap-24/media/image101.png
   :width: 6.61024in
   :height: 5.15354in
.. |image101| image:: ./chap-24/media/image102.png
   :width: 1.51929in
   :height: 1.59016in
.. |image102| image:: ./chap-24/media/image103.png
   :width: 6.08268in
   :height: 4.41338in
.. |image103| image:: ./chap-24/media/image104.png
   :width: 5.95709in
   :height: 3.41339in
.. |image104| image:: ./chap-24/media/image105.png
   :width: 5.93346in
   :height: 3.05157in
.. |image105| image:: ./chap-24/media/image106.png
   :width: 1.67283in
   :height: 1.58268in
.. |image106| image:: ./chap-24/media/image107.png
   :width: 1.67283in
   :height: 1.58268in
.. |image107| image:: ./chap-24/media/image108.png
   :width: 2.1374in
   :height: 1.71653in
.. |image108| image:: ./chap-24/media/image109.png
   :width: 6.93346in
   :height: 2.87795in
.. |image109| image:: ./chap-24/media/image110.png
   :width: 1.74449in
   :height: 1.59842in
.. |image110| image:: ./chap-24/media/image111.png
   :width: 6.40157in
   :height: 4.1063in
.. |image111| image:: ./chap-24/media/image112.png
   :width: 6.26811in
   :height: 3.84646in
.. |image112| image:: ./chap-24/media/image113.png
   :width: 6.50748in
   :height: 3.32717in
.. |image113| image:: ./chap-24/media/image114.png
   :width: 5.87008in
   :height: 2.65354in
.. |image114| image:: ./chap-24/media/image115.png
   :width: 1.51929in
   :height: 1.59449in
.. |image115| image:: ./chap-24/media/image116.png
   :width: 1.46457in
   :height: 1.38976in
.. |image116| image:: ./chap-24/media/image117.png
   :width: 1.90551in
   :height: 2.01929in
.. |image117| image:: ./chap-24/media/image118.png
   :width: 6.51614in
   :height: 2.62992in
.. |image118| image:: ./chap-24/media/image119.png
   :width: 1.66929in
   :height: 1.57835in
.. |image119| image:: ./chap-24/media/image120.png
   :width: 5.92913in
   :height: 3.7126in
.. |image120| image:: ./chap-24/media/image121.png
   :width: 2.07087in
   :height: 1.34252in
.. |image121| image:: ./chap-24/media/image122.png
   :width: 1.11024in
   :height: 1.57087in
.. |image122| image:: ./chap-24/media/image123.png
   :width: 5.70472in
   :height: 3.96024in
.. |image123| image:: ./chap-24/media/image124.png
   :width: 4.56338in
   :height: 3.04291in
.. |image124| image:: ./chap-24/media/image125.png
   :width: 5.12559in
   :height: 2.94528in
.. |image125| image:: ./chap-24/media/image126.png
   :width: 5.56654in
   :height: 3.87008in
.. |image126| image:: ./chap-24/media/image127.png
   :width: 6.55906in
   :height: 4.45709in
.. |image127| image:: ./chap-24/media/image128.png
   :width: 6.48071in
   :height: 4.44094in
.. |image128| image:: ./chap-24/media/image129.png
   :width: 6.55472in
   :height: 2.98819in
.. |image129| image:: ./chap-24/media/image130.png
   :width: 6.57835in
   :height: 2.83465in
.. |image130| image:: ./chap-24/media/image131.png
   :width: 5.98071in
   :height: 3.87441in
.. |image131| image:: ./chap-24/media/image132.png
   :width: 5.27992in
   :height: 1.66102in
.. |image132| image:: ./chap-24/media/image133.png
   :width: 5.6374in
   :height: 0.80709in
.. |image133| image:: ./chap-24/media/image134.png
   :width: 6.11811in
   :height: 1.83898in
.. |image134| image:: ./chap-24/media/image135.png
   :width: 5.72008in
   :height: 0.76811in
.. |image135| image:: ./chap-24/media/image136.png
   :width: 5.63386in
   :height: 0.75197in
.. |image136| image:: ./chap-24/media/image137.png
   :width: 5.59449in
   :height: 0.7126in
.. |image137| image:: ./chap-24/media/image138.png
   :width: 1.8189in
   :height: 2.54724in
.. |image138| image:: ./chap-24/media/image139.png
   :width: 6.22441in
   :height: 2.3189in
